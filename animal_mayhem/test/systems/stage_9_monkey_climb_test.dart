...
void main() {
  ...
  group('Climbable surface', () {
    ...
    test('blocked climbing fails safely', () {
      final ClimbableSurfaceComponent climbable = surface();
    ...
    test('cannot climb an unavailable route behind a closed gate', () {
      ...
      expect(world.monkey.canAttemptClimb(world.climbable), isFalse);
      expect(world.monkey.startClimb(world.climbable), isFalse);
      expect(world.monkey.hasCompletedClimb, isFalse);
      expect(world.monkey.position.x, closeTo(before.x, 0.01));
      expect(world.monkey.position.y, closeTo(before.y, 0.01));
    });
  });
  ...
  group('Commands', () {
    ...
    test('invalid climb target fails safely', () {
      final MayhemWorld world = MayhemWorld();
      world.monkey.position.setFrom(world.climbable.bottom);
      world.controller.handleAnimalTap(world.monkey);
